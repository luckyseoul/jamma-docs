...
```
  ...
  * ALLS HX2.1 OP                 (ACAX, JP, CNI-4750, "ASSY CASE ALLS HX2.1 OP")
        MBD: Gigabyte MCH31AM-S2
        CPU: Intel Core i3-8100
        RAM: 2x 4GB
        GPU: Nvidia GeForce GTX 1050Ti [HX2]
             Nvidia GeForce GTX 1650 (ZT-T16520Q-10B) [HX2.1 OP]
        SSD: TDK GBDisk GS1 120GB [MDA-E0019] [HX2]
             TDK GBDisk GS1 120GB [MDA-E0029] [HX2.1 OP]
        HDD: Western Digital WD5000LUCT 500GB [849-1004]
        SND: Realtek ALC888S
        OS: Windows 10 IoT LTSC 2019
